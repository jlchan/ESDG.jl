...
WARNING - don't modify any `integrator` fields within `monitor` or it may break the ODE solve.
"""
...
# https://github.com/trixi-framework/Trixi.jl/blob/99a7e2840872d0f1180a984dc034ec81be462a0b/src/callbacks_step/callbacks_step.jl#L17-L23
