...
plot!([-1;-1].+3/4*2,[-1;1].+2/4*2,seriescolor=:royalblue1,lw=3,ls=:dash,label = nothing)
plot!([-1;1].+3/4*2,[1;-1].+2/4*2,seriescolor=:royalblue1,lw=3,ls=:dash,label = nothing)
plot!([-1;1].+3/4*2,[-1;-1].+2/4*2,seriescolor=:royalblue1,lw=3,ls=:dash,label = nothing)
scatter!(r_tri.+3/4*2,s_tri.+2/4*2,markersize=5,markercolor=:royalblue1,markerstrokecolor=:black,markerstrokewidth=2)
scatter!(rf.+3/4*2,sf.+2/4*2,markersize=3,markershape=:rect,markercolor=:royalblue1,markerstrokecolor=:black,markerstrokewidth=2)
...
savefig("reference_tri_GPU_1.png")
